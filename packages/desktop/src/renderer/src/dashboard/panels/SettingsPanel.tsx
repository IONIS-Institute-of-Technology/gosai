      ...
      <Panel title="Camera">
        ...
        {!config ? (
          ...
          <div className="space-y-4">
            <p className="text-xs text-neutral-400">
              Default resolution and frame rate. Each app inherits these unless it overrides them in
              its own camera settings. Changes apply the next time the camera driver starts, and
